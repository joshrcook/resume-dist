...
(function () {
  ...
  _uikit2.default.scrollspy('.uk-section', {
    offsetTop: window.innerHeight / 2 * -1,
    repeat: true,
    hidden: false
  });

  _uikit2.default.util.on('.uk-section', 'inview', function (e) {
    var bodyClass = getBodyClass(e.target);
    if (typeof bodyClass === 'undefined') return;
    bodyEl.classList.add(bodyClass);
  });

  _uikit2.default.util.on('.uk-section', 'outview', function (e) {
    var bodyClass = getBodyClass(e.target);
    if (typeof bodyClass === 'undefined') return;
...
(function () {
  ...
  document.querySelectorAll('.uk-subnav > li').forEach(function (el) {
    _uikit2.default.scrollspy(el, {
  ...
  _uikit2.default.scrollspy('.uk-h1', {
    cls: 'uk-animation-fade uk-animation-slow',
    hidden: true,
    delay: 250
  });

  _uikit2.default.scrollspy('.uk-h2', {
    cls: 'uk-animation-slide-bottom-medium',
    offsetTop: window.innerHeight / -4
  });

  document.querySelectorAll('.uk-h2').forEach(function (el) {
...
(function () {
  ...
  _uikit2.default.heightViewport('.uk-section');
})();
...
//# sourceMappingURL=/js.f31421e9.map